 ...
 */
public class BlankFragmentTeste01 extends Fragment {

    private Button botaoMensagem;

    public BlankFragmentTeste01() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_blank_fragment_teste01, container, false);
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showMessageDialog("Olá","Você está no fragmento01");
            }
        };
